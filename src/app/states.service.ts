...
export class StatesService {
  ...
  private url = '/assets/mock/estados-cidades.json';
  private states = [
    {
      sigla: 'AC',
      nome: 'Acre',
  ...
  getCitiesFromState(state: String): Array<String> {
    return this.states.find(s => s.nome === state).cidades;
  }

  getAllCities(): Array<String> {
    this.cities = [];
    this.states.forEach(a => {
      a.cidades.forEach(c => this.cities.push(c));
    });
